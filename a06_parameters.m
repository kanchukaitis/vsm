...
parameters.Wmax  =       .2200;  % maximum soil moisture (field capacity, (v/v)
parameters.Wmin  =       .0100;  % minimum soil moisture (wilting point, v/v)
...
parameters.b(15) =         .2;  % The time step in cambium model (1/b(15)) = number of c-cycles/day)
